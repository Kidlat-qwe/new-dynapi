...
const TeacherCalendar = () => {
  ...
  // Get teacher's user_id from userInfo
  ...
  }, [viewMode, selectedMonth, selectedWeekStart, roomFilter, teacherId]);
  ...
  const fetchSchedules = async () => {
    ...
    try {
      ...
      const params = new URLSearchParams({
        ...
        teacher_id: teacherId, // Always filter by teacher's own ID
      });
