...
const Sidebar = ({ userType, isOpen, onClose }) => {
    ...
    switch (userType) {
      case 'superadmin':
        return [
          ...
          { path: '/superadmin/invoices', label: 'Invoices', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
        ];
      case 'admin':
        return [
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`bg-white shadow-sm border-r border-gray-200 w-64 min-h-[calc(100vh-4rem)] fixed left-0 top-16 z-40 transition-transform duration-300 ease-in-out ${
